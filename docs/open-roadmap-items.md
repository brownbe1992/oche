...
| 12 | Checkout Trainer: trick-question/bogey-number difficulty variant ("declare unsolvable" affordance + grading branch) and its conditional 💣 Bogey Buster badge | `docs/checkout-trainer-roadmap.md` | Medium |
