...
| 12 | Game Modes: Baseball — stats/achievements parity (Baseball-specific stat bubbles, Personal Bests, Player Profile/Home page toggle integration, achievements) — the core playable game itself shipped 2026-07, see the Done ledger below | `docs/game-modes-roadmap.md` | Medium |
